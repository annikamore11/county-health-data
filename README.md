...
-   `2025-county-health-filtered.xlsx`: CSV file from R script that contains cleaned and filtered data and an added geography level (US)
...
-   Data is delivered via bulk Excel and CSV files <https://www.countyhealthrankings.org/health-data/methodology-and-sources/data-documentation>
